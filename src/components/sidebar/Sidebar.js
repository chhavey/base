...
//   return (
//     <div
//       className={`fixed top-0 left-0 h-screen transition-transform ease-in-out ${
//         isOpen ? "translate-x-0" : "-translate-x-full"
//       } md:relative md:translate-x-0 flex flex-col md:${
//         collapsed ? "w-[10%]" : "w-[22%]"
//       } sidebar z-20 w-screen bg-primaryLight`}
